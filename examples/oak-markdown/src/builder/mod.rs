...
impl<'config> MarkdownBuilder<'config> {
    ...
    fn build_block(&self, node: RedNode<MarkdownLanguage>, source: &SourceText) -> Option<Block> {
        ...
        match kind {
            MarkdownElementType::Heading1 | MarkdownElementType::Heading2 | MarkdownElementType::Heading3 |
            MarkdownElementType::Heading4 | MarkdownElementType::Heading5 | MarkdownElementType::Heading6 => {
            ...
            MarkdownElementType::HorizontalRule => {
                Some(Block::HorizontalRule(HorizontalRule {
                    span: node.span(),
                }))
            }
    ...
    fn build_inline(&self, node: RedNode<MarkdownLanguage>, source: &SourceText) -> Option<Inline> {
        ...
        match kind {
            ...
            MarkdownElementType::Link => Some(Inline::Link {
                text: text,
                url: String::new(),
                title: None,
            }),
            MarkdownElementType::Image => Some(Inline::Image {
                alt: text,
                url: String::new(),
                title: None,
            }),
